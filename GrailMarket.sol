...
contract Marketplace is Upgradable {
    ...
    struct Auction {
        ...
        uint256 created;
        bool isGrail; // GrailCoin or Ether
    }
    ...
    function sellToken(
        ...
        _auction = Auction(_seller, _startPrice, _endPrice, _period, now, _isGrail);
    ...
    function buyToken(
        ...
        require(_auction.isGrail == _expectedIsGrail, "wrong currency");
        price = _getCurrentPrice(_tokenId);
        require(price <= _expectedPrice, "wrong price");
        require(price <= _value, "not enough ether/Grail");
...
contract GrailMarket is Marketplace {}